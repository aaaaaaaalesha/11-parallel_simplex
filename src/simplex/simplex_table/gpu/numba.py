...
"""
Представь, что ты Senior Data Science Engineer in Python
У тебя есть код, который решает задачу линейного программирования симплекс-методом.
Тебе же нужно воспользоваться модулем numba и numpy, чтобы код начал работать на GPU и увеличил свою производительность!
"""
